...
<% request.setCharacterEncoding("UTF-8"); 
	...
	String[] MajorNumber = request.getParameterValues("MajorNumber");
	String[] DeptNumber = request.getParameterValues("DeptNumber");
...
<body>
	<jsp:include page = "header.html" flush="false"></jsp:include>
	
	<img style="max-width: 100%;" src="/JSP/images/banner.png">
	
<div class="container">
    	<h4 align="center"><span class="blue-text text-darken-2">회원가입이 정상적으로 되었습니다.</span></h4><br>
    	<h6 align="center"><span class="blue-text text-darken-2"><%=StudentName %>님의 가입을 축하드립니다.</span></h6>
<table border="1" style="width:50%" align="center" class="centered"	>
    ...
    <br>
    	<p align ="center"><a class="waves-effect waves-light btn blue accent-4" href = "main.jsp">메인페이지로<i class="material-icons right">reply</i>
		</a></p>	   	
</div>
	...
	<script type="text/javascript" src="/JSP/js/materialize.min.js"></script>
</body>
</html>