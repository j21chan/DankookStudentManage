...
<form action = "joinCom.jsp" method = "post" align="center" class="centered">
<table border="1" style="width:50%" align="center" class="centered">
    ...
    <br>
		...
		<a class="waves-effect waves-light btn blue accent-4" href = "main.jsp">돌아가기<i class="material-icons right">keyboard_backspace</i>
		</a>	  	
	</form>
</div>
