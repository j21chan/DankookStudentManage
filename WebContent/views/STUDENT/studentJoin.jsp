...
<table border="1" style="width:50%" align="center" class="centered">
        ...
        <tr>
            ...
            <td>
                  <div class="input-field col s12">
                  <input type="hidden" name="deptNumber" value="0">
					일반 학생
				  </div>                	
            </td>
        </tr> 
    ...
    <br><center>
		...
		<a class="waves-effect waves-light btn blue accent-4" href = "/EGINE_MANAGE/student/joinView">돌아가기
