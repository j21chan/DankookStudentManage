...
<body>
	...
	<div class="container">
		...
		<h4 align="center">물품 추가 완료</h4>
		<div class="row">
	    	<div class="col s6 offset-s3">
	      		<div class="card blue accent-2">
					<div class="card-content white-text">
					<span class="card-title">물품이 정상적으로 추가되었습니다.</span><br>
					<p>추가하신 물품이 성공적으로 처리되었습니다.<br><br>
					또 다른 물품을 추가할 경우 하단에 있는 물품 추가 버튼을 눌러주시길 바랍니다.<br>
					</p>
			        </div>
	      		</div>
	    	</div><br>
