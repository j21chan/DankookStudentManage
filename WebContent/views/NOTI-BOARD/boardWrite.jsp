...
%>
	...
	<div class="container">
		...
		<div class="row">
			<form action="/EGINE_MANAGE/notiBoard/write" method="post">
				<table style="width:70%" border="1" align="center">
					<tr>
			            <td><h5>제 목</h5></td>
						<td>
							<input type = "text" name="bTitle" size="70" required/>
			        	</td>
			        </tr>
			        ...
			        <tr>
			            ...
			            <td>
							<%= writerId %>
							<input type = "hidden" name = "bId" value = "<%= writerId %>"/>
			            </td>        
			        </tr>
			        <tr>
			            <td><h5>내 용</h5></td>
			            <td>
			                <textarea name="bContent" rows="10" cols="65" style="height:200px" required></textarea>            
			            </td>        
			        </tr>
				</table> 
				<br><br>
				<div align = "center">
					...
					<a class="waves-effect waves-light btn blue accent-4" href="/EGINE_MANAGE/notiBoard/list">입력 취소
