...
<body>
	...
	<div class="container">
		...
		<h4 align="center">회원만 접근 할 수 있습니다.</h4><br>
		<div class="row">
	    	<div class="col s6 offset-s3">
	      		<div class="card blue accent-2">
					<div class="card-content white-text">
						<span class="card-title">비회원은 접근할 수 없습니다.</span><br>
						<p>공과대학 포털 사이트 회원 아니면 이용할 수 없는 페이지입니다.<br><br>
						회원이면 로그인을 하고 비회원이면 회원가입을 해주시길 바랍니다.<br><br>
