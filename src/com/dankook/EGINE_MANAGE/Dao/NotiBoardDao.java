...
public class NotiBoardDao {
	...
	public int writeBoard(String bId, String bTitle, String bContent) {
		...
		// 쿼리문
		// 1. 게시판 쓰기
		query = "insert into noti_board (bId, bTitle, bContent) values (?, ?, ?)";
	...
	public int deleteBoard(int bNumber) {
		...
		// 쿼리문
		query = "delete from noti_board where bNumber = ?";
	...
	public int modifyBoard(int bNumber, String bTitle, String bContent) {
		...
		// 쿼리문
		query = "update noti_board set bTitle = ?, bContent = ? where bNumber = ?";
	...
	public BoardDto viewBoard(int bNumber) {
		...
		// *** 게시글 보기 로직 ***
		// 쿼리문
		query = "select * from noti_board where bNumber = ?";
	...
	public ArrayList<BoardDto> listBoard() {
		...
		// 쿼리문
		query = "select * from noti_board order by bNumber desc";
	...
	private void upHit(int bNumber) {
		...
		// 쿼리문
		query1 = "select bHit from noti_board where bNumber = ?";
		query2 = "update noti_board set bHit = ? where bNumber = ?";
